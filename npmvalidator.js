...
email:'hsk99880'
// it will throw error because email is not in properform of email
// properties: [Object],
// kind: 'user defined',
// path: 'email',
// value: 'hsk99880',
// reason: TypeError: validator.isEmail is not a function

   })
        
        const result=await Playlist.insertMany([Industry10])
    console.log(result);
